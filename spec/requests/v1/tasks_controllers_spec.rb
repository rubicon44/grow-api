...
RSpec.describe V1::TasksController, type: :request do
  ...
  describe 'PUT #update (logged in)' do
    ...
    context 'updates the requested task with valid params' do
      let!(:update_valid_params1) { { task: FactoryBot.attributes_for(:task, title: "test_task_update1", content: "test_task_update1"), current_user_id: user.id } }
      it 'returns 204' do
      ...
      let!(:update_valid_params2) { { task: FactoryBot.attributes_for(:task, title: "test_task_update2", content: ""), current_user_id: user.id } }
      it 'when content is empty & returns 204' do
      ...
      let!(:update_valid_params3) { { task: FactoryBot.attributes_for(:task, title: "test_task_update3", start_date: "", end_date: ""), current_user_id: user.id } }
      it 'when both start_date and end_date are blank & returns 204' do
      ...
      let!(:update_valid_params4) { { task: FactoryBot.attributes_for(:task, title: "test_task_update4", start_date: "", end_date: "2023-05-10"), current_user_id: user.id } }
      it 'when start_date is blank and returns 204' do
      ...
      let!(:update_valid_params5) { { task: FactoryBot.attributes_for(:task, title: "test_task_update5", start_date: "2023-05-10", end_date: ""), current_user_id: user.id } }
      it 'when end_date is blank and returns 204' do
    ...
    context 'do not update the requested task with invalid params' do
      ...
      let!(:update_invalid_params1) { { task: FactoryBot.attributes_for(:task, title: "a" * 256), current_user_id: user.id } }
      it 'when title is too long & returns 422' do
      ...
      # content
      let!(:update_invalid_params2) { { task: FactoryBot.attributes_for(:task, content: "a" * 5001), current_user_id: user.id } }
      it 'when content exceeds the maximum length & returns 422' do
      ...
      let!(:update_invalid_params4) { { task: FactoryBot.attributes_for(:task, start_date: "20230101", end_date: "20231231"), current_user_id: user.id } }
      it 'with invalid date format & returns 422' do
      ...
      let!(:update_invalid_params5) { { task: FactoryBot.attributes_for(:task, start_date: "2023-01-011", end_date: "2023-12-311"), current_user_id: user.id } }
      ...
      let!(:update_invalid_params6) { { task: FactoryBot.attributes_for(:task, start_date: "2023-05-05", end_date: "2023-05-01"), current_user_id: user.id } }
      it 'when end_date is before start_date & returns 422' do
    ...
    context 'update non-existent tasks' do
      let!(:update_invalid_params7) { { task: FactoryBot.attributes_for(:task, title: "test_task_update", content: "test_task_update"), current_user_id: user.id } }
      it 'returns 404' do
    ...
    context 'when an unauthorized user update a task' do
      ...
      let!(:update_invalid_params8) { { task: FactoryBot.attributes_for(:task, title: "test_task_update", content: "test_task_update"), current_user_id: user2.id } }
      it 'returns 403' do
  ...
  describe 'DELETE #destroy (logged in)' do
    ...
    context 'do not delete the requested task when an unauthorized user delete a task' do
      let!(:user2) { FactoryBot.create(:user) }
      let!(:delete_invalid_params2) { { task: FactoryBot.attributes_for(:task, title: "test_task_delete"), current_user_id: user2.id } }
      it 'returns 403' do
