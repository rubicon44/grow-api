...
## インフラ構成図（Cacoo使用）
https://github.com/rubicon44/grow-api/assets/47108632/e9f6dcf2-04f7-4736-b47b-97b7c9a405df
...
- タスク管理機能
  ...
  - 一覧表示
    - 全体表示(最新順)（無限スクロール）
    - フォローしているユーザーのみ（無限スクロール）
  - 詳細表示
  - 編集
  - 削除

※今後は一覧表示にて、ユーザーの興味のあるカテゴリごとに上位表示する仕組みを実装予定。
